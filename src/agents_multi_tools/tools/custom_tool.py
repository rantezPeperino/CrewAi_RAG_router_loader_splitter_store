...
class ContentSearchTool(BaseTool):
    name: str = "ContentSearchTool"
    description: str = "Herramienta para buscar y extraer contenido relevante usando un retriever"

    def _run(self, retriever: BaseRetriever, prompt: str) -> str:
